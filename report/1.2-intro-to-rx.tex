...
\begin{minipage}{\linewidth}
\begin{lstlisting}[style=ScalaStyle, caption={\code{observeOn} in a Rx sequence}, label={lst:observeOn}, columns=fixed]
...
\begin{minipage}{\linewidth}
\begin{lstlisting}[style=ScalaStyle, caption={\code{subscribeOn} in a Rx sequence}, label={lst:subscribeOn}, columns=fixed]
...
More complex configurations with \code{subscribeOn} and \code{observeOn} can be made, which fall outside the scope of this section.
