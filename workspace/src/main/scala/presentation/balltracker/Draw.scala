 ...
 */
package presentation.balltracker
...
object Draw {
  ...
  def draw(pos: Position, setpoint: Setpoint, acc: Acceleration, history: History)(implicit gc: GraphicsContext): Unit = {
    drawBackground
    drawHistory(history)
  ...
  def drawSetpoint(setpoint: Setpoint)(implicit gc: GraphicsContext): Unit = {
    val (x, y) = setpoint
  ...
  def drawLine(ball: Position, setpoint: Setpoint)(implicit gc: GraphicsContext): Unit = {
